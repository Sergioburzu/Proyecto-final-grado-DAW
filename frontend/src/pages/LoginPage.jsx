  ...
  return (
    <div className="min-h-screen bg-base flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="card w-full max-w-md relative z-10 p-8 shadow-lg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between mb-4">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="text-[0.85rem] text-muted">Recordarme</span>
            </label>
            <button type="button"
              className="bg-transparent border-none cursor-pointer text-muted text-[0.85rem] transition-colors hover:text-accent">
        ...
        {/* Demo hint */}
        <div className="mt-6 p-3 bg-raised border border-border rounded-xl text-center">
          <p className="text-xs text-muted m-0">
            Demo: <strong className="text-accent">admin@sneakout.com</strong> / <strong className="text-accent">admin12345</strong>
          </p>
        </div>
      </div>
    </div>
